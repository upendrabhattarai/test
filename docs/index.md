...
!!! check-to-slot "Download and Installation Requirements:"

    * [Download the Dataset](https://www.dropbox.com/s/t3lkyz1pz021222/unix_lesson.tar.gz?dl=1)
    * Mac users:
        No other installation required.
    * Windows users:
        Download and install: [GitBash](https://git-scm.com/download/win)
